...
\pubyear{2023}
\copyrightyear{2023}
\externaleditor{\hl{Academic Editor: Firstname Lastname}}%MDPI: Please add if necessary
\datereceived{\hl{25 December 2022} %MDPI: Newly added information, please confirm.
} 
\daterevised{\hl{11 January 2023}} % Only for the journal Acoustics
\dateaccepted{\hl{13 January 2023}} 
\datepublished{} 
...
\Author{\hl{Polina Lemenkova} %MDPI: Please carefully check the accuracy of names and affiliations.
 $^{1,}$*\orcidA{} and Olivier Debeir \hl{$^{2}$}\orcidB{}}%MDPI: There is no aff 2 in affiliations part. Please add.
...
\address{%
$^{1}$ \quad Laboratory of Image Synthesis and Analysis (LISA), École Polytechnique de Bruxelles (Brussels Faculty of Engineering), Université Libre de Bruxelles (ULB), Building L, Campus du Solbosch, ULB---LISA CP165/57, Avenue Franklin D. Roosevelt 50, 1050 Brussels, Belgium\\
\hl{$^{2}$} \quad olivier.debeir@ulb.be}%MDPI: Please add.
