...
\caption{\hl{Mapping the prefectures of Japan.} (\textbf{a}) Script used for mapping by ‘ggplot2’, ‘ggmap’, ‘maps’ and ‘mapdata’ packages. (\textbf{b}) Map of the prefectures of Japan. Source: authors. \label{fig04}}%There is no (a,b) in the image. Please add.
\end{figure}   
